...
<div class="row">
	<h2 class="col-md-10">Crear Tareas</h2>
	<a class="btn btn-success" data-toggle="modal" data-target="#modal-crearTareas"><font color="white" size="3">Crear</font></a>
</div>
<div>
    <table class="table">
        <!--Table head-->
...
<!--Table-->
<div class="modal fade" id="modal-crearTareas" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
   <div class="modal-dialog modal-lg" role="document">
       <!--Content-->
       <div class="modal-content">
           <!--Header-->
           <div class="modal-header" style="background-color: blue">
               <h3 class="heading lead" style="color: white">Crear Tarea</h3>
           ...
           <div class="modal-body">
               ...
               <!-- Grid row -->
               <div class="col-md-6">
                   <input placeholder="Fecha Limite de Entrega" type="text" name="fechaFin" class="form-control datepicker">
               </div>
